...
public record FirePistolPayload(float yaw, float pitch) implements CustomPacketPayload {
	...
	public static final StreamCodec<RegistryFriendlyByteBuf, FirePistolPayload> CODEC =
			StreamCodec.composite(
					ByteBufCodecs.FLOAT, FirePistolPayload::yaw,
					ByteBufCodecs.FLOAT, FirePistolPayload::pitch,
					FirePistolPayload::new
			);
